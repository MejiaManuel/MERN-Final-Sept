...
function Todo() {
    ...
    const addTask = (e) => {
        ...
        axios.post(URL + '/addTodoList', { task: newTask, status: newStatus, deadline: newDeadline })
            .then(res => {
                console.log(res);
    ...
    const saveEditedTask = (id) => {
        ...
        axios.post(URL + '/updateTodoList/' + id, editedData)
            .then(result => {
                console.log(result);
                setEditableId(null);
                setEditedTask("");
    ...
    const deleteTask = (id) => {
        axios.delete(URL + '/deleteTodoList/' + id)
            .then(result => {
                console.log(result);
                window.location.reload();
            })
